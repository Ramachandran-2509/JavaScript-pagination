var data = [
 ...
 //var perPage = 5;
 //var totalPage = data.length / perPage;

 //for( let index=0; index < totalPage; index++){
   //var myButton=document.createElement("button");
   //myButton.innerText = index + 1;
   //myButton.setAttribute("onclick", "changePage("+index+")")
   //document.getElementById("pages").appendChild(myButton)
   //myButton.setAttribute("onclick", "changepage("+index+")")
...
function displayData(currentPageNumber)
{
  ...
  for(let index = 0; index < footerSize; index++){
    ...
    page.innerHTML=` <h2>${text.id}</h2> <h3>${text.name}</h3> <h5>${text.email}</h5>`;
